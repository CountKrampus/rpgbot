...
def _render_menu():
    ...
    print(_row(f"    {KEY_COLOR}[ 9]{RESET} {NAME_COLOR}Utilities{RESET}    {DESC_COLOR}— Map crawler, database updater & cache tools{RESET}", w))
...
def main_menu(driver):
    ...
    while True:
        ...
        # ----------------------------------------------------
            ...
            _not_yet_implemented("Utilities & Scraper")
